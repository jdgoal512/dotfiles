...
df -h -t ext4 -t ext3 | grep / | awk '{print "[\033[92m"$6"\033[37m "($5+0 -lt 25 ? "\033[92m" : ($5+0 -lt 75 ? "\033[36m" : "\033[31m"))$5"\033[37m "$3 "b/" $4 "b ]"}' | tr '\n' ' ' 
#df -h -t ext4 -t ext3 | grep / | awk '{print "["$3 "b/" $4 "b \033[92m"$6"\033[37m]"}' | tr -d '\n'
printf "\n   [2;36m/#'         '#\    "
